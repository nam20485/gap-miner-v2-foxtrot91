...
| **Target repo** | `nam20485/gap-miner-v2-foxtrot91` (a GitHub **template** repo) |
| **Status** | Active |
| **Date** | 2026-07-18 |
...
`gap-miner-v2-foxtrot91` is a **generic GitHub template repo**. It is not an application —
...
- `.agents/memory.md` — Current Activity / Completed Work / Decisions describe
  *gap-miner-v2-foxtrot91's own* development, not the clone's app.
- This repo's own `docs/plans/.completed/*` — e.g.
  `gap-miner-v2-foxtrot91-fix-plan.md`, `app-stacks-rules-plan.md`,
...
- **W1 step 5 (build hierarchy) is handled by a new parallel trigger** —
  ...
  `create-repo-gap-miner-v2-foxtrot91.ps1` hard-codes `-SkipProjectSetup` on the legacy
